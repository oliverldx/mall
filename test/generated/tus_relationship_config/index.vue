...
<script>
    import {fetchList,del} from '@/api/relationshipConfig'
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.$router.push({path:'/tus/addRelationshipConfig'});
            },
            handleUpdate(index, row){
                this.$router.push({path:'/tus/updateRelationshipConfig',query:{id:row.id}});
            },
