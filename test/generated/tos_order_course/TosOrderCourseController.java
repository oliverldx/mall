...
public class TosOrderCourseController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<TosOrderCourse>> list(@RequestParam(value = "pageSize", defaultValue = "4") Integer pageSize,
        TosOrderCourseQueryParam tosOrderCourseQueryParam,
        @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        PageHelper.startPage(pageNum,pageSize);
        List<TosOrderCourse> tosOrderCourseList = tosOrderCourseDao.getList(tosOrderCourseQueryParam);
