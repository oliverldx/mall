...
<script>
    import {fetchList, create, update, getById,getByActivityId} from '@/api/activity/groupDistribution';
                    ...
                    if (valid) {
                        this.$confirm('是否提交数据', '提示', {
                            ...
                            if (this.isEdit && this.isReallyEdit) {
                                update(this.activityId, this.groupDistribution).then(response => {
                                    this.$message({
                                        message: '修改成功',
                                        type: 'success',
                                        duration: 1000
                                ...
                                this.groupDistribution.trsActivityId=this.activityId
