...
public class TusCapitalRecordController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<TusCapitalRecordDto>>
        ...
        List<TusCapitalRecordDto> tusCapitalRecordList = tusCapitalRecordDao.getList(tusCapitalRecordQueryParam);
