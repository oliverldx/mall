...
<script>
    import {fetchList,del} from '@/api/promotionPoster'
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.$router.push({path:'/tus/addPromotionPoster'});
            },
            handleUpdate(index, row){
                this.$router.push({path:'/tus/updatePromotionPoster',query:{id:row.id}});
            },
