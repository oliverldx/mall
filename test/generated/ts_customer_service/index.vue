            ...
            <el-table ref="orderTable"
                ...
                <el-table-column label="客服电话" width="180" align="center">
                    <template slot-scope="scope">{{scope.row.phone}}</template>
                        ...
                        <el-table-column label="客服二维码" width="180" align="center">
...
<script>
    import {fetchList,del} from '@/api/customerService'
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.$router.push({path:'/ts/addCustomerService'});
            },
            handleUpdate(index, row){
                this.$router.push({path:'/ts/updateCustomerService',query:{id:row.id}});
            },
