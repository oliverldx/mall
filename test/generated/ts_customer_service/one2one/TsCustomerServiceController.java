...
public class TsCustomerServiceController {
    ...
    @ApiOperation("根据activityId获取客服中心")
    @RequestMapping(value = "/getByActivityId/{activityId}", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<TsCustomerService> getByActivityId(@PathVariable Long activityId) {
        TsCustomerService tsCustomerService = tsCustomerServiceDao.getByActivityId(activityId);
        return CommonResult.success(tsCustomerService);
    }
}
