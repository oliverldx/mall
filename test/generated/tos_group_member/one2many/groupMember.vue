    ...
    export default {
        ...
        methods: {
            ...
            confirmEdit(row) {
                ...
                update(this.userId, this.groupMember).then(response => {
                    this.$message({
                        message: '修改成功',
                        type: 'success',
                        duration: 1000
            ...
            getList() {
                ...
                this.listQuery.tusUserId=this.userId;
            ...
            handleSelectDialogConfirm(){
                ...
                for (let i = 0; i < this.dialogData.multipleSelection.length; i++) {
                    selectUsers.push(this.dialogData.multipleSelection[i].id);
                }
                this.$confirm('使用要进行添加操作?', '提示', {
                    ...
                    params.append("ids",selectUsers);
                    params.append("userId",this.userId);
                    createUserList(params).then(response=>{
            ...
            getDialogList(){
                fetchUserList(this.dialogData.listQuery).then(response=>{
