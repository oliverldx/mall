...
public class TosGroupMemberController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<TosGroupMember>> list(@RequestParam(value = "pageSize", defaultValue = "4") Integer pageSize,
        TosGroupMemberQueryParam tosGroupMemberQueryParam,
        @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        PageHelper.startPage(pageNum,pageSize);
        List<TosGroupMember> tosGroupMemberList = tosGroupMemberDao.getList(tosGroupMemberQueryParam);
