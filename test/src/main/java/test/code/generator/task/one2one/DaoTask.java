...
public class DaoTask extends AbstractTask {
    ...
    public void runTable(Table table) throws IOException, TemplateException {
        ...
        templateString = FileUtil.getTemplateString(FileTypeEnum.ONE2ONE_DAO_XML.getValue(), controllerData);
        FileUtil.generateFile(FileTypeEnum.ONE2ONE_DAO_XML.getValue(),table.getTableName(),templateString);
